...
public class HelloWorldIntentService {
	...
	public HelloWorldIntentService(){}
	...
	public String login(){
		...
		try {
			...
			System.out.println("HelloWorldIntentService.login()"+answer.get("access_token"));
			...
			System.out.println("HelloWorldIntentService.login()11"+alertobj.getJSONArray("alerts"));
	...
	public static void main(String args[]){
		...
		HelloWorldIntentService service = new HelloWorldIntentService();
		System.out.println("HelloWorldIntentService.main()"+service.login());
